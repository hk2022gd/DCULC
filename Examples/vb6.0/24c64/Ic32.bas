...
Declare Function IC_Pushout% Lib "dculc.dll" (ByVal icdev As Long)
...
Declare Function IC_Write64hex% Lib "dculc.dll" Alias "IC_Write64" (ByVal icdev As Long, ByVal offset%, ByVal length%, ByRef Databuffer As Byte)
Declare Function IC_Read64hex% Lib "dculc.dll" Alias "IC_Read64" (ByVal icdev As Long, ByVal offset%, ByVal length%, Databuffer As Byte)
