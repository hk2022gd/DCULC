...
Declare Function IC_ReadProtection_Hex% Lib "dculc.dll" (ByVal icdev As Long, ByVal offset%, ByVal l%, ByVal ProtBuffer$)
Declare Function IC_WriteProtection% Lib "dculc.dll" (ByVal icdev As Long, ByVal offset%, ByVal l%, ByVal ProtBuffer$)
Declare Function IC_WriteProtection_Hex% Lib "dculc.dll" (ByVal icdev As Long, ByVal offset%, ByVal l%, ByVal ProtBuffer$)
Declare Function IC_ReadCount_SLE4442% Lib "dculc.dll" (ByVal icdev As Long)
Declare Function IC_CheckPass_SLE4442% Lib "dculc.dll" (ByVal icdev As Long, Password As Byte)
